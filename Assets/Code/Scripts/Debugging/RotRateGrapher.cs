...
public class RotRateGrapher : Graphic
{
    [Header("Input")]
    [Tooltip("Input axis name for the joystick X (Project Settings > Input).")]
    public string axisName = "Rotation Rate"; // or "Horizontal"
    ...
    private void AddSample()
    {
        ...
        float value = (float)rotaryComputer.m_pitch; // get from rotary computer
